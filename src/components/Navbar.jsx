  ...
  return (
    <nav className=''>
      <div className='bg-d-green  py-6 lg:rounded-bl-full lg:rounded-br-full'>
        <p className='uppercase font-montserrat font-300 text-base lg:text-lg text-white text-center'>did you know xyz offers home delivery?</p>
      </div>
      <div className='container mx-auto flex items-center justify-between mt-6 px-6 lg:px-0'>
        ...
        <button className='rounded-full bg-l-green px-8 py-2 hidden lg:block'>
            <a href="#" className='uppercase font-montserrat font-semibold text-white'>start your order</a>
          </button>
